    ...
    <div className="page-fade-in nv-wrapper">
      ...
      {notifs.map((n) => {
        ...
        return (
          ...
          >
            <div className="nv-item-icon" aria-hidden="true">
              {isDeleted ? "🚪" : isAlert ? "🚨" : "✅"}
            </div>

            <div className="nv-item-body">
              {isDeleted ? (
                <div className="nv-item-text">
                ...
                <div className="nv-item-text">
                  ...
                  {isAlert ? (
                    <span className="nv-item-alert-title">{n.exercise_title}</span>
                  ) : (
                    <>concluiu <em>{n.exercise_title}</em></>
                  )}
                </div>
              )}
              <div className="nv-item-date">
                {formatDateTime(n.created_at)}
              </div>
            </div>

            {!n.read && (
              <span className={`response-badge nv-badge${isDeleted ? " nv-badge--deleted" : " nv-badge--new"}`}>
                Novo
              </span>
            )}
          </div>
