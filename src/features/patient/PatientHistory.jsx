    ...
    <div className="ph-page page-fade-in">
      <header className="ph-header">
        <div className="ph-header__text">
          ...
          <p className="ph-header__sub">Histórico e evolução dos seus exercícios</p>
        </div>
        {responses.length > 0 && tab === "history" && (
      ...
      {tab === "progress" ? (
        <PatientProgress session={session} />
      ) : (
        <>
          {responses.length === 0 && (
                          ...
                          <div className="ph-therapist-eval__meta">
                            ...
                            {r.noted_at && (
                              <span className="ph-therapist-eval__date">
                                {new Date(r.noted_at).toLocaleDateString("pt-BR", { day:"numeric", month:"short", year:"numeric" })}
                              </span>
                            )}
                          </div>
                        </div>
