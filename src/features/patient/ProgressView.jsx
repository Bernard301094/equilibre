...
import { calcStreak, localDateOffset, isThisWeek, toLocalDateStr } from "../../utils/dates";
...
export default function PatientProgress({ session }) {
  ...
  return (
    <div className="page-fade-in">
      ...
      <div className="grid-3 pp-stats-grid">
      ...
      {data.goal && (
        <div className="card pp-goal-card">
          <h3 className="pp-chart-title">Meta desta semana</h3>
      ...
      {data.scalePts.length >= 2 && (
        <div className="card pp-chart-card">
          <h3 className="pp-chart-title">Evolução das respostas de escala</h3>
      ...
      {data.moodPts.length >= 2 && (
        <div className="card pp-chart-card">
          <h3 className="pp-chart-title">Histórico do humor</h3>
